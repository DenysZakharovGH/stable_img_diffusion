...
class AutoParametrs:
    def __init__(self, ):
        ...
        self.fixed_code = False  # "if enabled, uses the same starting code across samples "
        ...
        self.n_iter = 1
        self.ddim_steps = 50
        self.ddim_eta = 0.0  # "eta=0.0 corresponds to deterministic sampling"

        self.prompt = "Nothing"  # whats to generate
...
while 1:
    generation_plot = input("Generate text description:")
    opt.prompt = generation_plot
